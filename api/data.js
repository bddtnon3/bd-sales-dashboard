...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Everyone who can log in sees the whole state, DCI included — the sales team read the
    // depot's score on their own 📈 tab; only the upload buttons are manager-only.
